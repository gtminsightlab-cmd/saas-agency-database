...
| **[BLOCKED-external]** | dotintel2 Sub-arc 3A SODA ingest → `data.transportation.gov` SODA API stability | 3rd-party FMCSA API. Stable as of 2026-05-15. Three resource IDs: `4y6x-dmck` BASIC, `rbkj-cgst` Inspection, `4wxs-vbns` Crash (memory `reference_fmcsa_soda_resource_ids.md`). |
