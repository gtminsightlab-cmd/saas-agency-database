...
export const metadata = {
  title: "FAQ — Seven16 Intel",
  description:
    "Common questions about Seven16 Intel — distribution intelligence for commercial insurance. Methodology, data sources, who it's for, and what it does NOT do.",
};
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Each record carries a freshness date tied to the most recent verification cycle. Instead of hiding behind a generic \"database updated regularly\" banner, Seven16 Intel exposes freshness at the row level so your team knows whether it's working from current signal or aging data.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "No. Seven16 Intel is especially useful for smaller carriers, MGAs, wholesalers, and program teams that cannot afford to waste quarters building the wrong agency list. The self-serve Producer and Growth tiers are sub-$500 P-card. Enterprise+ Distribution Expander covers the multi-state distribution-growth motion for VPs of Distribution.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "Yes. Seven16 Intel is designed so users can browse, filter, and research before purchasing export credits or a paid plan. Free Browse covers unlimited search; export credits apply only when you're ready to act.",
      },
      {
        q: "Can Seven16 Intel help with program launches?",
        a: "Yes. Program teams can use Seven16 Intel to identify agencies already appointed with relevant competing or adjacent markets by vertical, state, carrier appointment behavior, and specialization. See /use-cases for the five distribution plays.",
      },
      {
        q: "Can Seven16 Intel help with competitor displacement?",
        a: "Yes. If your program competes with a known carrier or parent group, Seven16 Intel can help identify agencies appointed with that market so your team can build a focused displacement campaign — context-rich outreach instead of cold calls.",
      },
    ],
  },
  {
    ...
    items: [
      {
        q: "Does Seven16 Intel make underwriting decisions?",
        a: "No. Seven16 Intel surfaces the data — appointments, vertical signal, carrier diversity, freshness. Whether to bind a risk, what terms, what coverage stays with the carrier and the licensed agent. The line is hard and architectural — see /about for the locked commitments.",
      },
      {
        q: "Do you have customer logos / testimonials?",
        a: "Not yet — Seven16 Intel is pre-revenue. Per the family's anti-promise: no fake metrics or invented customer claims. For diligence-level verification, we'll connect you with operator-network references on a call. Email partners@seven16group.com.",
      },
      {
        ...
        <section className="border-b border-slate-200 bg-slate-950 text-white">
          <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
            ...
            <h1 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">
              Straight answers about how Seven16 Intel works.
            </h1>
