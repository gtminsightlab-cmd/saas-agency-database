    ...
    <div>
      ...
      >
        <div className="max-w-3xl space-y-4 text-base leading-7 text-slate-700">
          ...
          <p>
            This policy covers the Agency Signal product at <code className="rounded bg-slate-100 px-1.5 py-0.5 text-sm">directory.seven16group.com</code> (and the future <code className="rounded bg-slate-100 px-1.5 py-0.5 text-sm">agencysignal.co</code> after domain cutover). It does not cover other Seven16 Group products (DOT Intel, DOTCarriers, DOTAgencies, BindLab) which publish their own policies on their own domains.
          </p>
        </div>
      </Section>
